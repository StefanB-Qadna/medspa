...
const socialLinks = [
  { label: "Instagram", href: "https://www.instagram.com/rejuvenateandrefinemedspa/", icon: <InstagramIcon /> },
  { label: "TikTok", href: "https://www.tiktok.com/@rejuvenateandrefine", icon: <TikTokIcon /> },
  { label: "Facebook", href: "https://www.facebook.com/profile.php?id=61582055431119", icon: <FacebookIcon /> },
];
