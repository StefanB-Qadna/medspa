...
export default function TeamMemberCard({
  ...
  return (
    ...
    >
      ...
      >
        <p className={cn("label mb-4", isPositionRight && "text-right")}>
          {jobPosition}
        </p>
      </motion.div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-end">
        ...
        >
          ...
          <div
            className={cn(
              "flex flex-col-reverse md:flex-row md:items-center gap-6 md:gap-8",
              isPositionRight && "md:justify-end",
            )}
          >
            {/* Circular CTA */}
            <Link
